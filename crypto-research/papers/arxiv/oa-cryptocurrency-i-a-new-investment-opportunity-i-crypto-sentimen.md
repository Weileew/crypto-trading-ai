---
title: 'Cryptocurrency: <i>A New Investment Opportunity?</i>'
authors: 'David Lee Kuo Chuen, Li Guo, Yu Wang'
url: 'https://doi.org/10.3905/jai.2018.20.3.016'
source: 'openalex/The Journal of Alternative Investments'
query: 'crypto sentiment analysis trading'
retrieved: '2026-06-29T22:31:25.746341+00:00'
year: '2017'
doi: 'https://doi.org/10.3905/jai.2018.20.3.016'
tier: 'C'
category: 'sentiment'
relevance: '1.0'
tags: [sentiment, risk, crypto]
---

# Cryptocurrency: <i>A New Investment Opportunity?</i>

- **Source**: OpenAlex (The Journal of Alternative Investments)
- **Tier**: C (supplementary)
- **Year**: 2017
- **DOI**: https://doi.org/10.3905/jai.2018.20.3.016
- **Strategy tags**: sentiment, risk, crypto
- **Relevance**: 1.0
...
## Auto-Finding
Sentiment finding: social/news sentiment has a measurable, lagged correlation with crypto returns — can be used as a confirmation filter.
